...
if session_number < 1:
    ...
    if mode == "N":
        ...
        print("critical error : answer not availaible")
        exit()
...
while True:
    ...
    if order == "settings":
        print ("debug message, line 71 : settings is starting")
        if mode == ("guest"):
        ...
        if mode == ("admin"):
            ...
            while settings == 1:
                ...
                if order_settings == ("help"):
                    print("here's the list of the commands : help : you know \n sessions : for create, delete and modify the sessions")
                else:
                     if order_settings == ("sessions"):
                        if second_number == 1:
                            ...
                            try:
                                ...
                                print("critical error, answer is not good")
                                seetings = 0
                                                    ...
                                                    if thing_to_modify == "P":
                                                        ...
                                                        for session_to_modify in session:
                                                            if session_to_modify == session:
                                                                print ("Oh, I find it !")
                                                        if session_mode_order == "M":
                                                            print ("Oh, error code, please look at script line 112")
